...
import { logo_lr, menu, close } from "../assets"
  ...
  return (
    ...
    >
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        >
          <img src={logo_lr} alt="logo" className='w-9 h-9 object-contain' />
        ...
        <div className='sm:hidden flex flex-1 justify-end items-center'>
          ...
          absolute top-20 right-0 mx-4 my-2 min-w[140px] z-20 rounded-xl`}>
